        ...
        $this->content = "<form>
            ...
            <div class='allprofiles'>
                <div class='firstprofile'>
                    <img class='profilG' src='../images/profil_souhaila.png' alt='Photo de profil Souhaila'>
                    <p class='textleftprofiles'>Bonjour je m'appelle Souhaila Moumane je suis en 2 ème année d'informatique au moment où le site a été crée, Je suis l'auteure du jeu d'objets cachés, je suis une grande fan des jeux de mystères à élucider et tout particulièrment des jeux d'objets cachés. Les jeux comme Agatha Christie et la saga Nightfall Mysteries m'ont beaucoup inspirés lors de la création du mini-jeu. J'espère que celui-ci vous a plu, en tout cas, j'ai pris beaucoup de plaisir à le programmer.</p> 
                </div>
                <div class='secondprofile'>
                    <img class='profilD' src='../images/profil_alexis.png' alt='Photo de profil Alexis'>
                    <p class='textrightprofiles'>Salut, moi c'est Alexis Mariotti je suis en seconde année de BUT informatique. Je suis l'auteur du jeu de traduction, ainsi que de tout le systeme de connexion et des avis du site. Je suis passioné de jeux vidéo ainsi que de bob marley. J'espere que mon travail vous à plu, en ce qui me concerce j'ai aimé le développer.</p> 
                </div>
                <div class='thirdprofile'>
                    <img class='profilG' src='../images/profil_victor.png' alt='Photo de profil Victor'>
                    <p class='textleftprofiles'>Yo, moi c'est Victor Bouveret, j'étudie l'informatique depuis maintenant 2 ans. Je suis l'auteur du jeu d'orientation ainsi que du jeu final de choix du meurtrier mais également le css man principal du site, Je suis passioné de jeux calmes et reposants comme DOOM Eternal, j'ai beaucoup apprécie travailler sur ce projet et j'espère qu'il vous plaira !</p>
                </div>
                <div class='fourthprofile'>
                    <img class='profilD' src='../images/profil_william.png' alt='Photo de profil William'>
                    <p class='textrightprofiles'>Salut c'est William Goujon durant la conception du projet j'étais en 2e année de BUT informatique. Je suis passionné de jeux vidéo, d'E-sport et de streaming.Je suis l'auteur du jeu de texte à trous, j'espère que le jeu qu'on a fait vous a plu et je vous remercie d'y avoir joué.</p>
                </div>
            </div>";
